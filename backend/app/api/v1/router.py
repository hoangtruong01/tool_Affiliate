...
api_v1_router.include_router(metrics_router, prefix="/jobs", tags=["Performance Metrics"])
api_v1_router.include_router(analytics_router, prefix="/analytics", tags=["Analytics"])
api_v1_router.include_router(admin_router, prefix="/admin", tags=["Admin"])
api_v1_router.include_router(integrations_router, prefix="/integrations", tags=["Integrations"])
api_v1_router.include_router(publish_router, prefix="/publish", tags=["Publishing"])
